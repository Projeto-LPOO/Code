...
<aside>
    <nav>
        <ul>
            <li><a href="${pageContext.request.contextPath}/WEB-INF/views/autenticado/home/home.jsp">Dashboard</a></li>
            <a href="${pageContext.request.contextPath}/autenticado/users">Lista de usuarios</a>
            <a href="${pageContext.request.contextPath}/autenticado/AvailabilityServlet">Agenda</a>
...
<main>
    <section>
        ...
        <%-- TABELA CENTRALIZADA --%>
        <table border="1" style="width: 70vw; padding: 16px; margin: 0 auto; border-collapse: collapse; text-align: center;">
            <thead>
