package com.aura.availability.view;
...
public class View {
    ...
    private void findById() {
        ...
        Availability disp = controller.findById(id);
    ...
    private void updateAvailability() {
        ...
        Availability dispExistente = controller.findById(id);
    ...
    private void deleteAvailability() {
        ...
        try {
            controller.deleteAvailability(id);
        } catch (Exception e) {
